...
argparser.add_argument('--validEvery',type=int, default = 200000)
...
argparser.add_argument('--loadModelPath', type=str, default='')
argparser.add_argument('--resultPath', type=str, default='result.txt')
...
argparser.add_argument('--embedCategory',action='store_true')
